            ...
            <div className="md:hidden border-t border-gray-200">
              <div className="px-2 pt-2 pb-3 space-y-1">
                <div className="px-3 py-2 rounded-md bg-gray-50">
                  ...
                  <button
                    onClick={handleLogout}
                    className="w-full bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition duration-200"
                  >
                    Logout
                  </button>
                </div>
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
            ...
            <button
              ...
              className="bg-gradient-to-r from-orange-500 to-amber-500 text-white px-6 py-3 rounded-xl font-semibold hover:from-orange-600 hover:to-amber-600 transition duration-200 flex items-center"
            >
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-base font-medium text-gray-900 capitalize">{user?.role || 'User'}</p>
            </div>
            <div>
              <p className="text-sm text-gray-500 mb-1">Provider</p>
              <p className="text-base font-medium text-gray-900 capitalize">{user?.provider || 'Local'}</p>
            </div>
          </div>
        </div>
      </main>
